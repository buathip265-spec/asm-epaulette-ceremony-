...
// เชื่อมต่อ Google Apps Script Web App URL สำหรับซิงค์ QR และส่งอีเมล
...
export default function App() {
  ...
  const handleSendQrCodeEmails = async () => {
    const confirmSend = window.confirm(`ต้องการส่งอีเมลการ์ดดิจิทัลพร้อม QR Code ให้ผู้เข้าร่วมทุกคนใช่หรือไม่?`);
    if (!confirmSend) return;
    ...
    try {
      ...
      alert('✅ ส่งอีเมลการ์ดดิจิทัลให้ทุกคนเรียบร้อยแล้ว!');
    } catch (err) {
      console.error(err);
